...
import com.dengun.message.library.LibraryPersistenceBeanRemote;
...
public class EJBMessageTester {
    ...
    public void testMesssageDrivenEjb() {
        try {
            ...
            LibraryPersistenceBeanRemote libraryBean1 = (LibraryPersistenceBeanRemote) ctx.lookup(LibraryPersistenceBeanRemote.class.getName());
